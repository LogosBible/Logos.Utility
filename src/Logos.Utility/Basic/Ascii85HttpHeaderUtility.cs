...
namespace Logos.Utility.Basic
{
    ...
    public static class Ascii85HttpHeaderUtility
    {
        /// <summary>
                ...
                switch (ch)
                {
                    ...
                    default:
                        if ((ch < c_firstCharacter) || (ch > c_lastCharacter))
                            throw new FormatException(StringUtility.FormatInvariant("Invalid character '{0}' in Ascii85 string.", ch));
                        else
                            sb.Append(ch);
                        break;
                }
                    ...
                    case '~':
                        ...
                        switch (encoded[i])
                        {
                            ...
                            case 'j':
                                ...
                                break;
                            default:
                                throw new FormatException(StringUtility.FormatInvariant("Unexpected character following '~': '{0}'", encoded[0]));
                        }
                        break;
                    default:
                        sb.Append(encoded[i]);
