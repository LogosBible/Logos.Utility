...
namespace Logos.Utility.Tests
{
	class StreamUtilityTests
	{
        ...
        public void Setup()
        {
            ...
            //.NET Core lacks the 1252 and 949 encodings by default.
            //Registering this provider solves that. (The Logos.Utility library
            //can't do this registration itself, at least not in a way that
            //would apply to the GetEncoding method calls that precede the
